...
import static patched.org.apache.avro.SchemaCompatibility.checkReaderWriterCompatibility;
import static patched.org.apache.avro.TestSchemas.A_DINT_B_DINT_RECORD1;
import static patched.org.apache.avro.TestSchemas.A_DINT_RECORD1;
import static patched.org.apache.avro.TestSchemas.A_INT_B_DINT_RECORD1;
import static patched.org.apache.avro.TestSchemas.A_INT_B_INT_RECORD1;
import static patched.org.apache.avro.TestSchemas.A_INT_RECORD1;
import static patched.org.apache.avro.TestSchemas.A_LONG_RECORD1;
import static patched.org.apache.avro.TestSchemas.BOOLEAN_SCHEMA;
import static patched.org.apache.avro.TestSchemas.BYTES_SCHEMA;
import static patched.org.apache.avro.TestSchemas.BYTES_UNION_SCHEMA;
import static patched.org.apache.avro.TestSchemas.DOUBLE_SCHEMA;
import static patched.org.apache.avro.TestSchemas.DOUBLE_UNION_SCHEMA;
import static patched.org.apache.avro.TestSchemas.EMPTY_RECORD1;
import static patched.org.apache.avro.TestSchemas.EMPTY_UNION_SCHEMA;
import static patched.org.apache.avro.TestSchemas.ENUM1_ABC_SCHEMA;
import static patched.org.apache.avro.TestSchemas.ENUM1_AB_SCHEMA;
import static patched.org.apache.avro.TestSchemas.ENUM1_BC_SCHEMA;
import static patched.org.apache.avro.TestSchemas.FIXED_4_BYTES;
import static patched.org.apache.avro.TestSchemas.FLOAT_SCHEMA;
...
import static patched.org.apache.avro.TestSchemas.INT_FLOAT_UNION_SCHEMA;
import static patched.org.apache.avro.TestSchemas.INT_LIST_RECORD;
import static patched.org.apache.avro.TestSchemas.INT_LONG_FLOAT_DOUBLE_UNION_SCHEMA;
import static patched.org.apache.avro.TestSchemas.INT_LONG_UNION_SCHEMA;
...
import static patched.org.apache.avro.TestSchemas.LONG_ARRAY_SCHEMA;
import static patched.org.apache.avro.TestSchemas.LONG_LIST_RECORD;
import static patched.org.apache.avro.TestSchemas.LONG_MAP_SCHEMA;
import static patched.org.apache.avro.TestSchemas.LONG_SCHEMA;
...
import static patched.org.apache.avro.TestSchemas.STRING_ARRAY_SCHEMA;
import static patched.org.apache.avro.TestSchemas.STRING_INT_UNION_SCHEMA;
import static patched.org.apache.avro.TestSchemas.STRING_SCHEMA;
import static patched.org.apache.avro.TestSchemas.STRING_UNION_SCHEMA;
import static patched.org.apache.avro.TestSchemas.assertSchemaContains;
...
import patched.org.apache.avro.TestSchemas.ReaderWriter;
